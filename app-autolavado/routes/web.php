...
Route::get('/municipalities-by-code/{municipioCode}', [DirSatMunController::class, 'getByMunicipioCode']);
...
Route::put('/update-datos-fiscales', [UpdateDatosFiscalesController::class, 'updateDatosFiscales']);
