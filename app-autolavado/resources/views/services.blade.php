...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Services</h1>
			...
			<!-- servicesSection -->
			<section class="servicesSection pb-6 pb-sm-8 pb-lg-12 pt-10 pt-md-13 pt-lg-17 pt-xl-21">
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
							<header class="headingHead fzMedium mb-7 mb-md-12 text-center">
								<h2>
									<strong class="d-block text-uppercase hTitle fwMedium mb-4">We care your car</strong>
									<span class="d-block">Services We Provide</span>
								</h2>
								<p>We have over 20 years of experience providing carwash & detail services for both Commercial and individuals without compromise quality.</p>
							</header>
						</div>
					</div>
					<div class="row">
						<div class="col-12 col-md-6 col-lg-4">
							<!-- esColumn -->
							<div class="esColumn position-relative rounded d-block mb-6 mb-lg-11 mt-10">
								<div class="imgHolder position-relative rounded overflow-hidden">
									<img src="https://via.placeholder.com/405x365" class="img-fluid rounded w-100" alt="image description">
								</div>
								<div class="esCaption position-absolute px-4 px-xl-8 py-14">
									...
									<h3 class="h3Small mb-1"><a href="servicesSingle.html">Express Exterior</a></h3>
						...
						<div class="col-12 col-md-6 col-lg-4">
							...
							<div class="esColumn position-relative rounded d-block mb-6 mb-lg-11 mt-10">
								...
								<div class="esCaption position-absolute px-4 px-xl-8 py-14">
									...
									<h3 class="h3Small mb-1"><a href="servicesSingle.html">Auto Detailing</a></h3>
									<div class="onHover descriptWrap">
										<p>Keep your car like Showroom Condition</p>
										<ul class="list-unstyled pl-0 mb-0 mt-5 pcFeaturesList pcfAlt">
											<li>Seats Washing</li>
						...
						<div class="col-12 col-md-6 col-lg-4">
							...
							<div class="esColumn position-relative rounded d-block mb-6 mb-lg-11 mt-10">
								...
								<div class="esCaption position-absolute px-4 px-xl-8 py-14">
									...
									<h3 class="h3Small mb-1"><a href="servicesSingle.html">Full Service Wash</a></h3>
									<div class="onHover descriptWrap">
										<p>Keep your car like Showroom Condition</p>
										<ul class="list-unstyled pl-0 mb-0 mt-5 pcFeaturesList pcfAlt">
											<li>Seats Washing</li>
						...
						<div class="col-12 col-md-6 col-lg-4">
							...
							<div class="esColumn position-relative rounded d-block mb-6 mb-lg-11 mt-10">
								...
								<div class="esCaption position-absolute px-4 px-xl-8 py-14">
									<span class="icnWrap position-absolute rounded-circle d-flex align-items-center justify-content-center shadow">
										<i class="icomoon-car-wash-2"><span class="sr-only">icon</span></i>
									</span>
									<h3 class="h3Small mb-1"><a href="servicesSingle.html">Complete Detail Wash</a></h3>
									<div class="onHover descriptWrap">
										<p>Keep your car like Showroom Condition</p>
										<ul class="list-unstyled pl-0 mb-0 mt-5 pcFeaturesList pcfAlt">
											<li>Seats Washing</li>
						...
						<div class="col-12 col-md-6 col-lg-4">
							...
							<div class="esColumn position-relative rounded d-block mb-6 mb-lg-11 mt-10">
								...
								<div class="esCaption position-absolute px-4 px-xl-8 py-14">
									<span class="icnWrap position-absolute rounded-circle d-flex align-items-center justify-content-center shadow">
										<i class="icomoon-fuel"><span class="sr-only">icon</span></i>
									</span>
									<h3 class="h3Small mb-1"><a href="servicesSingle.html">Oil Changing</a></h3>
									<div class="onHover descriptWrap">
										<p>Keep your car like Showroom Condition</p>
										<ul class="list-unstyled pl-0 mb-0 mt-5 pcFeaturesList pcfAlt">
											<li>Seats Washing</li>
						...
						<div class="col-12 col-md-6 col-lg-4">
							...
							<div class="esColumn position-relative rounded d-block mb-6 mb-lg-11 mt-10">
								...
								<div class="esCaption position-absolute px-4 px-xl-8 py-14">
									<span class="icnWrap position-absolute rounded-circle d-flex align-items-center justify-content-center shadow">
										<i class="icomoon-repair"><span class="sr-only">icon</span></i>
									</span>
									<h3 class="h3Small mb-1"><a href="servicesSingle.html">Preventative Services</a></h3>
									<div class="onHover descriptWrap">
										<p>Keep your car like Showroom Condition</p>
										<ul class="list-unstyled pl-0 mb-0 mt-5 pcFeaturesList pcfAlt">
											<li>Seats Washing</li>
						...
						<div class="row align-items-center">
							...
							<div class="col-12 col-lg-4">
								<div class="extraWrap pl-sm-15 pl-lg-0 text-lg-right">
									<a href="contact.html" class="btn btnThemeWhite position-relative border-0 p-0 btnMinXLarge" data-hover="Request a Call Back">
			...
			<!-- offerYouChoiceSection -->
			<section class="offerYouChoiceSection bg-light2 mt-n23 pb-7 pt-35 pt-md-40 pt-lg-43 pt-lgwd-50 pb-md-9 pb-lg-16 pb-xl-22">
				<div class="container">
					<div class="row">
						<div class="col-12 col-lgwd-8">
							<div class="row align-items-center mb-md-10 mb-lgwd-0">
								<div class="col-12 col-md-6">
									<div class="pr-xl-10 pr-xlwd-15">
										<h2 class="h2">Offers you a variety of choices</h2>
										<p>Our service offers you a variety of choices to meet your needs and most Accurate and fair-price service Estimate.</p>
										<a href="pricingPackage.html" class="btn btnThemeAlt position-relative border-0 p-0 mt-3 mt-md-6 btnMinLarge" data-hover="Pricing Details">
											<span class="d-block btnText">Pricing Details</span>
										</a>
									</div>
								</div>
								<div class="col-12 col-md-6">
									<a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="videoBoxWrap position-relative overflow-hidden lightbox d-block w-100 my-8 my-md-0" data-fancybox="true">
										<img src="https://via.placeholder.com/405x290" class="img-fluid w-100" alt="image description">
						...
						<div class="col-12 col-lgwd-4">
							<ul class="list-unstyled pl-xl-5 mb-0 servicesList">
			...
			<!-- processBlock -->
			<section class="processBlock bg-secondary text-center pt-10 py-md-13 py-lg-16" style="background-image: url(images/bgPattern03.png);">
				<div class="container">
			...
			<!-- whatAdvantageSection -->
			<section class="whatAdvantageSection pt-10 pb-5 pt-md-15 pb-md-10 py-lg-18 pt-xl-21 pb-xl-22">
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-10 offset-md-1 col-xl-6 offset-xl-3">
							<header class="headingHead fzMedium mb-12 text-center">
								<h2>
									<strong class="d-block text-uppercase hTitle fwMedium mb-4">Why Choose Us</strong>
									<span class="d-block">What advantages will you get when washing your car?</span>
								</h2>
							</header>
						</div>
					</div>
					<div class="row align-items-center">
						...
						<div class="col-12 col-md-6 col-lg-4 text-center d-none d-lg-block">
							<div class="imgWrap position-relative" style="background-image: url(images/img0075.png);">
								<img src="https://via.placeholder.com/305x520" class="img-fluid" alt="image description">
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<!-- ftColumnGrid -->
