...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Full Service Wash</h1>
			...
			<!-- ItemfullBlock -->
			<article class="ItemfullBlock serviceSingle py-8 py-md-10 py-lg-14 py-xl-22">
				<div class="container">
					<div class="row">
						<div class="col-12 col-lg-8 col-xl-9">
							<div class="pr-xl-14">
								<header class="fzLarge mb-6">
									<h4 class="h4">Full Service Wash</h4>
									<p class="text-lDark mb-6">One of the most common additions people make to their cars in order to keep the heat out is a windshield visor. Cars become warm in the summer because direct sunlight enters in through the windows look at three main — not the other way around.</p>
								</header>
								<p class="mb-6">It was installed globally, an annual market growth of 22 percent. It is continuing its progress towards becoming a mainstream competitive salary and economy reports by mine.</p>
								<div class="imgWrap rounded overflow-hidden mb-8 mb-lg-12">
									<img src="https://via.placeholder.com/875x425" class="img-fluid rounded" alt="image description">
								</div>
								<h5 class="h5">Inspect and Fill Transmission and Differential:</h5>
								<p class="mb-6">One of the most common additions people make to their cars in order to keep the heat out is a windshield visor. Cars become warm in the summer because direct sunlight enters in through the windows. This is why we park in the shade whenever we can. Since the largest windshield.</p>
								<div class="row pt-3 pt-sm-6 pb-4 mx-xl-n4">
									<div class="col-12 col-md-6 px-xl-4">
										<div class="imgWrap rounded overflow-hidden mb-4 mb-sm-8 mb-md-0 text-center">
											<img src="https://via.placeholder.com/425x345" class="img-fluid rounded" alt="image description">
										</div>
									</div>
									<div class="col-12 col-md-6 px-xl-4">
										...
										<ul class="list-unstyled pl-0 mb-0 pt-3 servicesList text-primary">
								...
								<p class="mb-6 mb-xl-10">In fact, wind is becoming cheap enough in many places in the U.S. and around the world to compete effectively with fossil fuels. local economy, but manufacturing components locally also helps to eliminate long-distance transport costs, for the large components in particular.</p>
								<!-- serviceCardWidget -->
								<div class="serviceCardWidget shadow rounded overflow-hidden mb-8 mb-xl-12">
									<div class="scwHead bg-primary d-flex align-items-center justify-content-between px-3 px-sm-5 py-3">
										<h5 class="h5 text-white mb-0">The Works Wash</h5>
										<h5 class="h5 priceHeading text-white mb-0">$13.00</h5>
									</div>
									<div class="scwBody px-3 px-sm-5 py-5">
										<strong class="d-block mb-4 fwMedium fontAlter text-primary">This wash package includes:</strong>
										<ul class="list-unstyled pl-0 mb-4 pcFeaturesList pcfAlt">
											<li>Pre-soak penetrating</li>
											<li>Spa Foam Cleaner</li>
											<li>Heated Super Dry</li>
											<li>Haevy-duty Cleaning</li>
											<li>Rain-X Treatment</li>
											<li>Tire Shine and Wheel</li>
										</ul>
										<p>*(SUV & Minivan upcharges apply to each included service)</p>
									</div>
								</div>
								<h5 class="h5">Steering Fuild Check and Fill:</h5>
								<p class="mb-6">Thomas Edison may have been behind the invention of the electric light bulb, but he did not work alone. Edison worked alongside partners, both financial and commercial, to get his inventions off the ground.</p>
								<ul class="list-unstyled mb-6 mb-xl-10 pl-0 dotsList">
									<li>A three-party relationship – the responsible party who prepares the information to be assured; the independent practitioner who assures the information.</li>
									<li>Agreed subject matter – in the case of an audit, this would be the annual accounts of a company. However it could be almost anything in practice – the systems operated by a state lottery, a company’s greenhouse gas emissions, controls over a supply chain etc.</li>
									<li>Systems operated by a state lottery, a company’s greenhouse gas emissions, controls.</li>
								</ul>
								<div class="table-responsive mb-6 mb-xl-10">
									<!-- tableDefault -->
									<table class="table tableDefault fontAlter mb-0">
										<thead>
											<tr>
												<th colspan="2" class="text-center">À La Carte Services</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td class="cctService">Air Freshener</td>
												<td class="cctAmount text-right">$1.00</td>
											</tr>
											<tr>
												<td class="cctService">Armor All Tires</td>
												<td class="cctAmount text-right">$2.00</td>
											</tr>
											<tr>
												<td class="cctService">Gleam Polish Wax</td>
												<td class="cctAmount text-right">$4.00</td>
											</tr>
											<tr>
												<td class="cctService">Extra Vacuuming</td>
												<td class="cctAmount text-right">$5.00 &amp; Up</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td class="cctAmount text-right">By Estimate</td>
											</tr>
											<tr>
								...
								<div class="bookAppointmentWidget bg-white shadow rounded px-5 py-9 overflow-hidden position-relative">
									<div class="row align-items-center">
										<div class="col-12 col-xl-8 position-static">
											<div class="extraWrap pl-sm-21">
												<i class="icomoon-car-service icn d-none d-sm-block"><span class="sr-only">icon</span></i>
												<h5 class="h5 mb-1">Schedule an Appointment</h5>
												<p class="mb-xl-0">Call for more details or to schedule an appointment.</p>
											</div>
										</div>
										<div class="col-12 col-xl-4">
											<div class="extraWrap pl-sm-21 pl-xl-0 text-xl-right">
												<a href="bookingSystem.html" class="btn btnThemeAlt position-relative border-0 p-0 btnMinLarge" data-hover="Book Appointment">
													<span class="d-block btnText">Book Appointment</span>
												</a>
											</div>
										</div>
								...
								<hr class="mt-12 mb-7">
								<!-- saShareAside -->
								<aside class="saShareAside d-flex align-items-center justify-content-between mt-8 mt-md-13">
									<strong class="h5 d-block text-lDark fwSemiBold title mb-0 mr-3 fontAlter">Share Article:</strong>
							...
							<aside class="dscSidebar pt-1 ml-xl-n5">
								...
								<nav class="widget mb-6 mb-lg-10 widgetDepartsNav widgetBgLight py-5 px-6 rounded">
									...
									<ul class="list-unstyled pl-0 mx-n2 mb-0 mb-3 fontAlter">
										<li>
											<a href="javascript:void(0);">Express Exterior</a>
										</li>
										<li>
											<a href="javascript:void(0);">Auto Detailing</a>
										</li>
										<li class="active">
											<a href="javascript:void(0);">Complete Detail Wash</a>
										</li>
										<li>
											<a href="javascript:void(0);">Oil Changing</a>
										</li>
										<li>
											<a href="javascript:void(0);">Preventative Services</a>
										</li>
									</ul>
								</nav>
								<!-- widget / widgetDocs -->
								<section class="widget mb-6 mb-lg-10 widgetDocs">
									<ul class="list-unstyled drItemsList pl-0">
										<li>
											<div class="drItemRow position-relative d-flex px-3 px-md-6 py-3 rounded overflow-hidden">
												<span class="icnWrap flex-shrink-0 pt-1 mr-3">
													<i class="icomoon-document icn d-none d-sm-block"><span class="sr-only">icon</span></i>
												</span>
												<div class="descrWrap">
													<h4 class="fontBase fwMedium mb-1">
														<a href="javascript:void(0);">Download Auto_Carwash Pricing_List</a>
													</h4>
