...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Testimonials</h1>
					...
					<div class="row">
						<div class="col-12 col-md-10 offset-md-1 px-xl-13">
							...
							<div class="quotesSlider">
								<div>
									<!-- clientQuote -->
									<blockquote class="clientQuote fontCabin position-relative pt-25 pt-sm-0 pl-sm-35 pl-lg-40 pl-lgwd-50 mb-0">
										<q class="d-block position-relative mb-4 mb-md-6 mb-lg-7 pt-4 pl-12 pl-sm-0">I love the efficiency of my Car Wash on Sunrise Valvernasa in Mangho Qor nova. A smiling greeting, an excellent wash, and on my way—clean. The best car wash ever!</q>
										<cite class="d-block pl-12 pl-sm-0">
											<!-- profilePicWrap -->
											<span class="profilePicWrap position-absolute overflow-hidden rounded-circle">
												<img src="https://via.placeholder.com/140x140" class="img-fluid w-100 h-100 imgFit rounded-circle" alt="Donald Salvor || Customer - Audi">
											</span>
											<span class="eWrap d-block">
												<strong class="d-block fwSemi text-primary text-capitalize mb-1">Donald Salvor</strong>
												<strong class="d-block subtitle font-weight-normal fontBase">Customer - Audi</strong>
											</span>
										</cite>
									</blockquote>
								</div>
								<div>
									...
									<blockquote class="clientQuote fontCabin position-relative pt-25 pt-sm-0 pl-sm-35 pl-lg-40 pl-lgwd-50 mb-0">
										...
										<cite class="d-block pl-12 pl-sm-0">
											<!-- profilePicWrap -->
											<span class="profilePicWrap position-absolute overflow-hidden rounded-circle">
												<img src="https://via.placeholder.com/140x140" class="img-fluid w-100 h-100 imgFit rounded-circle" alt="Kristina Castle || Medical Scientist">
											</span>
											<span class="eWrap d-block">
												<strong class="d-block fwSemi text-primary text-capitalize mb-1">Dr. Kristina Castle</strong>
								...
								<div>
									...
									<blockquote class="clientQuote fontCabin position-relative pt-25 pt-sm-0 pl-sm-35 pl-lg-40 pl-lgwd-50 mb-0">
										...
										<cite class="d-block pl-12 pl-sm-0">
											<!-- profilePicWrap -->
											<span class="profilePicWrap position-absolute overflow-hidden rounded-circle">
												<img src="https://via.placeholder.com/140x140" class="img-fluid w-100 h-100 imgFit rounded-circle" alt="Donald Salvor || Global Initiative">
											</span>
											<span class="eWrap d-block">
												<strong class="d-block fwSemi text-primary text-capitalize mb-1">Anthony Wills</strong>
			...
			<section class="customerReviewsBlock py-7 py-sm-9 py-md-13 py-lg-16 pt-xl-18 pb-xl-20">
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-10 offset-md-1 col-xl-6 offset-xl-3">
							<h2 class="text-center mb-6 mb-md-10 mb-lg-14">
								<strong class="d-block text-uppercase hTitle fwMedium mb-4">Customer Review</strong>
					...
					<div class="row">
						<div class="col-12 col-md-6 col-lg-4 d-flex">
							<!-- clientFeedback -->
							<article class="clientFeedback bg-white shadow rounded mb-8 mb-md-10 mb-lg-14 px-3 py-5 px-sm-5 p-xl-8">
						...
						<div class="col-12 col-md-6 col-lg-4 d-flex">
							...
							<article class="clientFeedback bg-white shadow rounded mb-8 mb-md-10 mb-lg-14 px-3 py-5 px-sm-5 p-xl-8">
								<blockquote class="clientQuoteii mb-0">
									<q class="d-block mb-8">
										They need locations everywhere! My favorite is that their vacuum cleaners are always working good most business referrals services !
									</q>
									<div class="d-flex align-items-center">
										<span class="cImgWrap rounded-circle flex-shrink-0 mr-2">
											<img src="https://via.placeholder.com/60x60" class="rounded-circle" alt="image descripition">
					...
					<div class="text-center mt-xl-n2">
						<a href="javascript:void(0);" class="btn btnThemeAlt position-relative border-0 p-0 mx-auto" data-hover="Load More Reviews">
							<span class="d-block btnText">Load More Reviews</span>
						</a>
					</div>
				</div>
			</section>
