...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Pricing Plans</h1>
			...
			<!-- plansBlock -->
			<section class="plansBlock py-7 py-md-10 pt-lg-13 pt-xl-18 pb-xl-16">
				<div class="container">
					<div class="row">
					...
					<div class="row">
						<div class="col-12 col-md-6 col-xl-3 d-flex">
							...
							<article class="w-100 mx-auto mb-6 position-relative bg-white shadow rounded text-center priceColumn pt-9 pb-30 px-6">
								...
								<a href="javascript:void(0);" class="btn btnThemeAlt position-absolute border-0 p-0 mx-auto" data-hover="Select">
			...
			<!-- processBlock -->
			<section class="processBlock bg-secondary text-center pt-10 py-md-15" style="background-image: url(images/bgPattern03.png);">
				<div class="container">
			...
			<!-- seeBenefitsAside / seeBenefitsAsideVII -->
			<aside class="seeBenefitsAside seeBenefitsAsideVII bg-primary pb-5 pt-10 py-md-12 py-lg-16 pt-xl-20">
				<div class="container">
					<h4 class="h4 mb-8 mb-md-12 text-center">
						<strong class="d-block text-uppercase hTitle fwMedium mb-3 ">See benifits</strong>
						<span class="d-block text-white">Each Visits Include Special Benifits</span>
					</h4>
					<ul class="list-unstyled fabFeaturesList mb-0 d-flex flex-wrap justify-content-center position-relative">
						<li>
							<div class="featureColumn text-center px-1 px-sm-3 px-md-5 px-xl-7 mb-6">
								<span class="icnWrap d-flex align-item-center justify-content-center mb-2">
									<i class="icomoon-vacuum-cleaner"></i>
								</span>
								<h6 class="h6 mb-0 position-relative text-white">
			...
			<!-- faqSection -->
			<section class="faqSection pb-5 pt-10 pt-md-15 pb-md-9 pt-xl-20">
				<div class="container">
					<header class="headingHead fzMedium mb-12 text-center">
						<h2>
						...
						<p>If your question isn’t listed below, please contact our Customer Service on 1-800-123-4567.</p>
					</header>
					<div class="row">
						<div class="col-12 col-lg-6">
							<!-- accordion / faqAccordion -->
							<div class="accordion faqAccordion mb-8 mb-lg-12" id="ctdepartsAccordion">
								...
								<div class="ctaccRow mb-4">
									<div class="ctaccOpener">
										<a class="fontAlter" href="#ctr2" data-toggle="collapse" aria-expanded="false" aria-controls="ctr2">What size vehicles can fit through the car wash tunnel?</a>
									</div>
									<div class="collapse ctaccSlide" id="ctr2" data-parent="#ctdepartsAccordion">
										<div class="overflow-hidden px-5 pb-1">
								...
								<div class="ctaccRow mb-4">
									<div class="ctaccOpener">
										<a class="fontAlter" href="#ctr4" data-toggle="collapse" aria-expanded="false" aria-controls="ctr4">How often should I wax my vehicle?</a>
									</div>
								...
								<div class="ctaccRow mb-4">
									<div class="ctaccOpener">
										<a class="fontAlter" href="#ctr5" data-toggle="collapse" aria-expanded="false" aria-controls="ctr5">Why is my car still wet after the dry cycle?</a>
									</div>
						...
						<div class="col-12 col-lg-6">
							<!-- accordion / faqAccordion -->
							<div class="accordion faqAccordion mb-8 mb-lg-12" id="ctdepartsAccordion01">
								<div class="ctaccRow mb-4">
									<div class="ctaccOpener">
										<a class="fontAlter" href="#ctr01" data-toggle="collapse" aria-expanded="false" aria-controls="ctr01">Do you use brushes? Are you touchless?</a>
									</div>
								...
								<div class="ctaccRow mb-4">
									<div class="ctaccOpener">
										<a class="fontAlter" href="#ctr02" data-toggle="collapse" aria-expanded="false" aria-controls="ctr02">My car is still in the auto pound. Do I have to request a hearing?</a>
									</div>
									<div class="collapse ctaccSlide" id="ctr02" data-parent="#ctdepartsAccordion01">
										<div class="overflow-hidden px-5 pb-1">
											<p>Fast Lane Shinkansen global hand-crafted premium. Washlet bespoke conversation bulletin. Comme des Garçons Asia-Pacific vibrant, boutique perfect wardrobe handsome ginza.</p>
										</div>
									</div>
								...
								<div class="ctaccRow mb-4">
									<div class="ctaccOpener">
										<a class="fontAlter" href="#ctr03" data-toggle="collapse" aria-expanded="false" aria-controls="ctr03">I have a bug shield or bike rack, etc. Is it safe?</a>
									</div>
								...
								<div class="ctaccRow mb-4">
									<div class="ctaccOpener">
										<a class="fontAlter" href="#ctr04" data-toggle="collapse" aria-expanded="false" aria-controls="ctr04">How often can I wash my vehicle?</a>
									</div>
									<div class="collapse ctaccSlide" id="ctr04" data-parent="#ctdepartsAccordion01">
										<div class="overflow-hidden px-5 pb-1">
											<p>One of the most common additions people make to their cars in order to keep the heat out is a windshield visor. Cars become warm in the summer because direct sunlight enters in through the windows. This is why we park in the shade whenever we can. Since the largest windshield.In fact, wind is becoming cheap enough in many places in the U.S. and around the world to compete effectively with fossil fuels.</p>
										</div>
									</div>
								...
								<div class="ctaccRow mb-4">
									<div class="ctaccOpener">
										<a class="fontAlter" href="#ctr05" data-toggle="collapse" aria-expanded="false" aria-controls="ctr05">How do I pay for my unlimited wash club plan?</a>
									</div>
									<div class="collapse ctaccSlide" id="ctr05" data-parent="#ctdepartsAccordion01">
										<div class="overflow-hidden px-5 pb-1">
											<p>One of the most common additions people make to their cars in order to keep the heat out is a windshield visor. Cars become warm in the summer because direct sunlight enters in through the windows. This is why we park in the shade whenever we can. Since the largest windshield.In fact, wind is becoming cheap enough in many places in the U.S. and around the world to compete effectively with fossil fuels.</p>
										</div>
									</div>
			...
			<!-- getDiscountAside -->
			<aside class="getDiscountAside text-center pb-10 pb-md-15 pb-xl-20">
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 px-xl-8 px-xlwd-12">
							<span class="icnWrap d-flex justify-content-center mb-5">
								<i class="icomoon-credit-card"></i>
							</span>
							<h4 class="h4 mb-6">Join our car wash club and <span class="text-secondary font-italic">Get 20% Discount</span> & Unlimited Wash Scheme!</h4>
							<a href="javascript:void(0);" class="btn btnThemeAlt position-relative border-0 p-0 mx-auto" data-hover="Join Unlimited Wash Club">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-12 col-sm-6 col-lg-3 mb-10 mb-lg-0">
								...
								<form action="#" class="subscritionForm">
									<div class="inputWrap">
