					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Blog Grid</h1>
			...
			<div class="blogListingSection py-10 py-md-14 py-lgwd-18 py-xl-22">
				<div class="container">
					<div class="row">
						...
						<div class="col-12 col-sm-6 col-lg-4 col">
							<!-- blockPostColumn -->
							<article class="blockPostColumn position-relative fontAlter mb-6" data-media-type-video data-category="Auto Care">
								<div class="imgWrap overflow-hidden mb-5">
									<img src="https://via.placeholder.com/405x275" class="img-fluid w-100" alt="image description">
						...
						<div class="col-12 col-sm-6 col-lg-4 col">
							<!-- blockPostColumn -->
							<article class="blockPostColumn position-relative fontAlter mb-6" data-category="Maintenance">
								<div class="imgWrap overflow-hidden mb-5">
									<img src="https://via.placeholder.com/405x275" class="img-fluid w-100" alt="image description">
								</div>
								<strong class="d-block fwmMedium title mb-2">
