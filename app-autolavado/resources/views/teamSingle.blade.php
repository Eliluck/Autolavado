...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Andron Black</h1>
			...
			<article class="tmContentBlock py-9 py-md-13 py-lg-16 pt-xl-22 pb-xl-22">
				<div class="container">
					<header class="tmcbDescriptionBox shadow bg-white d-lg-flex pt-4 pt-lg-0 position-relative overflow-hidden mb-7 mb-md-10 mb-lg-15">
						<span class="imgHolder flex-shrink-0 bgCover mx-auto mx-lg-0 d-block" style="background-image: url(https://via.placeholder.com/425x425);"></span>
						<div class="descrWrap flex-grow-1 px-5 pt-6 pb-6 px-xl-12 pt-xl-9 pb-xl-12">
							<div class="row">
								<div class="col-12 col-md-5">
									<h2 class="fwMedium h3Small mb-1">Andron Black</h2>
									<h3 class="text-secondary fwSemiBold fontBase text-uppercase">Owner/Operator</h3>
									<hr class="mccSeprator mx-0 mt-2 mb-3">
									<dl class="tmcbInfosList overflow-hidden">
										<dt>Expertice:</dt>
										<dd>Strategy, Marketing</dd>
										<dt>Experience:</dt>
										<dd>15 Years</dd>
										<dt>Phone:</dt>
										<dd>
											<a href="tel:5074521254">507-452-1254</a>
										</dd>
										<dt>Email:</dt>
										<dd>
								...
								<div class="col-12 col-md-7">
									<div class="pl-xl-10 pt-7 pt-md-0">
										<div class="fzMedium mb-5">
											<p>Carwash isn’t your main business, but it is ours and we love it! For more inform about our commercial wash services and pricing and to schedule.</p>
										</div>
										<p>Worldwide, there is a wide variance in local laws and customs regarding the powers and responsibilities of a mayor.</p>
										<span class="signIcn d-block mt-4">
											<img src="images/signature1.png" class="img-fluid" alt="signature">
										</span>
									</div>
								</div>
							</div>
						</div>
						<i class="icomoon-3345656 position-absolute icnWatermark"><span class="sr-only">icon</span></i>
					</header>
					<h4 class="h4 fwSemiBold mb-5">Biography</h4>
					<p class="mb-5">Jaye launched his career in politics with stints in advance, labor organizing and political journalism. He began work as an account executive and then Senior Vice President and Creative Director at Clinton Reilly Campaigns, at the time the nation’s largest political consulting firm. In 1990, he founded his own firm, Terris and Jaye, which grew into one of the nation’s largest political consulting firms. In 2001, he founded Storefront Political Media to provide political client.</p>
					<p class="mb-5">Every one of his works is covered with a mantle of sacredness, through which he demonstrates the importance of architecture as a means of expression of human memory. In 1998, he founded his own firm, Terris and Jaye, which grew into one of the nation’s largest political consulting firms. In 2006, he founded Storefront Political Media to provide political clients the full range of media and message services..</p>
					<div class="row mt-7 mt-md-10 mb-2 pb-15 pb-lg-0">
						<div class="col-12 col-lg-6">
							<h4 class="h4 fwSemiBold mb-5">Education</h4>
							<ul class="list-unstyled edupiInfosList d-flex flex-wrap">
								<li>
									<div class="edupiilWrap position-relative pb-5">
										<strong class="d-block fwMedium text-lDark fwMedium fontAlter timeTitle position-relative mb-2">
						...
						<div class="col-12 col-lg-6">
							<h4 class="h4 fwSemiBold mb-5">Professional Skills</h4>
							<div class="row antmate">
								<div class="col-12 col-sm-6 text-center">
									<!-- pieWrapper -->
									<div class="pieWrapper mb-15 mb-sm-0">
										<span class="label"><span class="dataCount" data-count-start="0" data-count-end="80">80</span>%</span>
										<svg width="221" height="221" class="align-top">
											<circle class="cr1" r="105" cx="110" cy="110" fill="none" stroke="#eeeeee" stroke-width="8"></circle>
											<circle class="cr2" r="105" cx="110" cy="110" fill="none" stroke="#2db7ff" stroke-width="8" stroke-dasharray="300 87"></circle>
										</svg>
								...
								<div class="col-12 col-sm-6 text-center">
									<div class="pieWrapper mb-">
										<span class="label"><span class="dataCount" data-count-start="0" data-count-end="95">95</span>%</span>
										<svg width="221" height="221" class="align-top">
											<circle class="cr1" r="105" cx="110" cy="110" fill="none" stroke="#eeeeee" stroke-width="8"></circle>
											<circle class="cr2" r="105" cx="110" cy="110" fill="none" stroke="#2db7ff" stroke-width="8" stroke-dasharray="300 87"></circle>
										</svg>
					...
					<h4 class="h4 fwSemiBold mb-5">Professional Info</h4>
					...
					<div class="ctFormWrap mt-7 mt-md-9 mt-lg-11 mt-xl-13 bg-white shadow rounded px-3 px-md-5 px-lg-8 py-4 py-md-7 py-lg-10">
						<h4 class="h4 fwSemiBold mb-6">Contact Me</h4>
						<form action="#" class="contactForm">
							...
							<button type="button" class="btn btnThemeAlt text-capitalize position-relative border-0 p-0 mt-2 btnMinLarge" data-hover="Send Message">
