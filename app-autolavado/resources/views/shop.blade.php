					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Shop</h1>
					...
					<div class="row">
						...
						<div class="col-12 col-lg-8 col-lgwd-9">
							<div class="pl-md-5 pl-xl-15 fontAlter">
								<header class="ctSorterWrapHeader">
									<div class="row align-items-md-center">
										<div class="col-12 col-md-5 text-center text-md-left order-2 order-md-1">
											<p><strong class="fwmMedium">Showing 1–9 of 13 results</strong></p>
										</div>
										<div class="col-12 col-md-7 d-md-flex justify-content-md-end order-1 order-md-2">
											<!-- dsSortDropdown -->
											<div class="dropdown dsSortDropdown mb-2 mb-md-0">
												<a class="dropdown-toggle" href="javascript:void(0);" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Default Sorting</a>
												<!-- dropdown menu -->
								...
								<div class="row">
									<div class="col-12 col-md-6 col-lgwd-4 d-flex">
										<article class="proItemCol text-center position-relative mb-6 w-100">
									...
									<div class="col-12 col-md-6 col-lgwd-4 d-flex">
										<article class="proItemCol text-center position-relative mb-6 w-100" data-featured-tag="Sale!">
											<div class="prodImgWrap mb-3 mb-md-5">
												<a href="singleProduct.html"><img src="https://via.placeholder.com/230x230" class="img-fluid" alt="image description"></a>
											</div>
											<div class="prodDescWrap">
									...
									<div class="col-12 col-md-6 col-lgwd-4 d-flex">
										<article class="proItemCol text-center position-relative mb-6 w-100">
											...
											<div class="prodDescWrap">
												<div class="prodCategory">Equipements</div>
												<h6 class="h6 mb-1 productName"><a href="singleProduct.html">Wash Equipement-X56</a></h6>
												<ul class="list-unstyled ratingList mb-1 d-flex justify-content-center">
													<li class="active"><i class="fas fa-star"></i></li>
													<li class="active"><i class="fas fa-star"></i></li>
													<li class="active"><i class="fas fa-star"></i></li>
									...
									<div class="col-12 col-md-6 col-lgwd-4 d-flex">
										<article class="proItemCol text-center position-relative mb-6 w-100" data-featured-tag="Sale!">
											...
											<div class="prodDescWrap">
												<div class="prodCategory">Equipements</div>
												<h6 class="h6 mb-1 productName"><a href="singleProduct.html">Twin Exhaster Pipe</a></h6>
												<ul class="list-unstyled ratingList mb-1 d-flex justify-content-center">
													<li class="active"><i class="fas fa-star"></i></li>
													<li class="active"><i class="fas fa-star"></i></li>
													<li class="active"><i class="fas fa-star"></i></li>
									...
									<div class="col-12 col-md-6 col-lgwd-4 d-flex">
										<article class="proItemCol text-center position-relative mb-6 w-100">
											...
											<div class="prodDescWrap">
												<div class="prodCategory">Wash Products</div>
												<h6 class="h6 mb-1 productName"><a href="singleProduct.html">Canist For Liquids 50ml</a></h6>
												<ul class="list-unstyled ratingList mb-1 d-flex justify-content-center">
													<li class="active"><i class="fas fa-star"></i></li>
													<li class="active"><i class="fas fa-star"></i></li>
													<li class="active"><i class="fas fa-star"></i></li>
								...
								<nav aria-label="Page navigation">
									<ul class="pagination justify-content-center mt-4 mt-sm-6 mt-md-8 mb-0 pb-0">
