		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Typography</h1>
			...
			<div class="contntWrap py-6 py-md-10 py-lg-14 py-xl-18 py-xlwd-22">
				<div class="container">
					...
					<hr class="my-10 my-md-15 border-0">
					<!-- columnComponent -->
					<div class="columnComponent">
						<h2 class="h2 mb-4">Text Columns</h2>
						<h4 class="h4 mb-3">Full width text (4 columns)</h4>
						<p>True elements of surprise, they break up the compositional layout, creating a stylistic point of interest, and interrupting the continuous effect of the fabric covering, visually lightening the volume at the rear. A solution designed to optimise both look and form, created with the know-how about design and the savoir-faire associated with fine tailoring that have always distinguished the Minotti brand.</p>
						<hr class="my-10 border-0">
						<h4 class="h4 mb-2">2 columns</h4>
						<div class="row">
							<div class="col-12 col-sm-6">
								<p>True elements of surprise, they break up the compositional layout, creating a stylistic point of interest, and interrupting the continuous effect of the fabric overing, visually lightening the volume at the rear.</p>
							</div>
							<div class="col-12 col-sm-6">
								<p>True elements of surprise, they break up the compositional layout, creating a stylistic point of interest, and interrupting the continuous effect of the fabric overing, visually lightening the volume at the rear.</p>
							</div>
						...
						<hr class="my-10 border-0">
						<h4 class="h4 mb-2">3 columns</h4>
						<div class="row">
							<div class="col-12 col-md-6 col-lg-4">
								<p>Visually lightening the volume at the rear. A solution designed to optimise both look and form, created with the know-how about design.</p>
							</div>
							<div class="col-12 col-md-6 col-lg-4">
								<p>Visually lightening the volume at the rear. A solution designed to optimise both look and form, created with the know-how about design.</p>
							</div>
						...
						<hr class="my-10 border-0">
						<h4 class="h4 mb-2">4 columns</h4>
						<div class="row">
							<div class="col-12 col-sm-6 col-md-4 col-lg-3">
								<p>True elements of surprise, they break up the compositional layout, creating a stylistic point of interest.</p>
							</div>
							<div class="col-12 col-sm-6 col-md-4 col-lg-3">
								<p>True elements of surprise, they break up the compositional layout, creating a stylistic point of interest.</p>
							</div>
					...
					<div class="textComponent">
						<h2 class="h2 mb-4">Text Elements</h2>
						<p class="mb-6"><span class="text-secondary">Mobile app development services catering to other businesses</span> can easily be tracked on various well known B2B rating and review platforms where based upon client satisfaction and several other parameters the development companies and their credentials are explained in an objective manner. for choosing the development company of your preference often the location plays a hugely important role. The biggest impact created by the <span class="text-primary">difference in location is the uneasiness of working</span> with people in different time zones. Apart from this, some regions also offer more cost-effective development solutions.</p>

						<p class="mb-6">True elements of surprise, <span class="bg-primary text-white">they break up the compositional</span> layout, creating a stylistic point of interest, and interrupting the continuous effect of the fabric covering, visually lightening the volume at the rear. A solution designed to optimise both look and form, <span class="bg-secondary text-white">created with the know-how about design</span> and the savoir-faire associated with fine tailoring that have always distinguished the Minotti brand.</p>

						<p class="mb-6">Every element of the system is made with exquisite goose down padding to ensure maximum comfort, features cushions finished with a piping that defines their profile and a distinctive aluminium strip, slightly rounded at the edges which skims the floor, in a brand new polished Brandy colour finish.</p>
					</div>
					<hr class="my-10 my-md-15 border-0">
					<!-- dropcapsComponent -->
					<div class="dropcapsComponent">
						<h2 class="h2 mb-5">Dropcaps</h2>
						<div class="row">
							<div class="col-12 col-md-6">
								<p><span class="dropCap rounded-lg text-white bg-secondary d-flex justify-content-center align-items-center mr-2 mt-1 font-weight-bold float-left">B</span>Bonocle ipsum dolor sit amet elegant bulletin Melbourne sharp, ryokan conversation business class essential Scandinavian Zürich. Bulletin sastha sunspel discerning classic Shinkansen Washlet Singapore Tsutaya finest way on artisanal. Destination sleepy exquisite, hand-crafted business.</p>
							</div>
							<div class="col-12 col-md-6">
								<p><span class="dropCap rounded-sm text-white bg-primary d-flex justify-content-center align-items-center mr-2 mt-1 font-weight-bold float-left">B</span>Bonocle ipsum dolor sit amet elegant bulletin Melbourne sharp, ryokan conversation business class essential Scandinavian Zürich. Bulletin sastha sunspel discerning classic Shinkansen Washlet Singapore Tsutaya finest way on artisanal. Destination sleepy exquisite, hand-crafted business.</p>
							</div>
						</div>
					</div>
					<hr class="my-10 my-md-15 border-0">
					<!-- blockquoteComponent -->
					<div class="blockquoteComponent">
						<h2 class="h2 mb-5">Blockquote</h2>
						<blockquote class="feedbackSlide fontAlter position-relative pl-10 pl-xl-12">
					...
					<hr class="my-12 my-md-17 border-0">
					<!-- blockquoteComponent -->
					<div class="lsitingComponent">
						<h2 class="h2 mb-5">Listing</h2>
						<div class="row">
							<div class="col-12 col-sm-6 col-md-4 col-lg-3">
								<ul class="list-unstyled pl-0 mb-0 listDefaultStyles numberList mb-7">
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-3">
								<ul class="list-unstyled pl-0 mb-0 pcFeaturesList pcfAlt mb-7">
									<li>Pre-soak penetrating</li>
									<li>Spa Foam Cleaner</li>
									<li>Heated Super Dry</li>
									<li>Haevy-duty Cleaning</li>
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-3">
								<ul class="list-unstyled pl-0 mb-0 servicesList servicesListVII mb-7">
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-3">
								<ul class="list-unstyled pl-0 mb-0 servicesList serAlt">
									<li>Brake Service Repair</li>
									<li>Door panels / seats wiped</li>
									<li>Rubber mats washed</li>
									<li>Computerized Diagnostics</li>
