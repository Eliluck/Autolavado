...
<body>
	<!-- pageWrapper -->
	<div id="pageWrapper" class="page_404">
		<!-- phStickyWrap -->
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">404 Error</h1>
			...
			<!-- 404_Section -->
			<section class="pt-6 pb-8 pt-md-11 pb-md-15 pt-xl-18 pb-xl-22">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-12 col-sm-9 col-lg-6 col-xlwd-4 text-center">
							...
							<a href="home1.html" class="btnThemeAlt btn btnNoOver mt-5 btnMinXLarge">Back to Home <i class="fas fa-arrow-right btnIcn ml-2" aria-hidden="true"><span class="sr-only">icon</span></i></a>
						</div>
					</div>
				</div>
			</section>
