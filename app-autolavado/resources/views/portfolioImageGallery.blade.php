	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Image Gallery</h1>
			...
			<section class="ItemfullBlock py-8 py-md-10 py-lg-14 py-xl-22">
				<div class="container">
					<ul class="list-unstyled ifbFiltersList d-flex isoFiltersList mb-lg-12 mb-xl-14 fontAlter flex-wrap justify-content-center">
						<li class="active">
						...
						<div class="col-12 col-md-6 col-lg-4 isoCol washing interior">
							...
							<article class="gPhoColumnGallery position-relative overflow-hidden mb-6">
								<div class="imgWrap position-relative">
									...
									<a href="https://via.placeholder.com/405x300" class="icnSearch lightbox position-absolute" data-fancybox="true"><i class="lnr lnr-magnifier"><span class="sr-only">icon</span></i></a>
								</div>
							</article>
						</div>
