					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Machine Washing</h1>
										<ul class="list-unstyled cbbPageList text-capitalize d-flex align-items-center justify-content-center flex-wrap mb-0 p-0">
											...
											<li><a href="portfolioSingle1.html">Portfolio</a></li>
											<li>Machine Washing</li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="container">
					<div class="row">
									...
									<div class="col-12 col-sm-6">
										...
										<article class="gPhoColumnGallery position-relative overflow-hidden mb-6">
											<div class="imgWrap position-relative">
												<img src="https://via.placeholder.com/425x315" class="img-fluid w-100" alt="image description">
												<a href="https://via.placeholder.com/425x315" class="icnSearch lightbox position-absolute" data-fancybox="true"><i class="lnr lnr-magnifier"><span class="sr-only">icon</span></i></a>
											</div>
										</article>
									</div>
									<div class="col-12 col-sm-6">
						...
						<div class="col-12 col-lg-4 col-xl-3 mb-3">
							<div class="dscSidebar pt-1 ml-xl-n5">
								<header class="fzLarge mb-6">
									<p class="text-lDark mb-6">We help our clients to build their best possible economic We understand you’re saving for all different life events:</p>
								</header>
								<p class="mb-6">You have within you, right now, at this very moment, all that is necessary for you to become the happy, successful person you’ve always wanted to be. All you need to do is unlock the riches that have been locked away with-in you.</p>
								<ul class="psMetaList fontAlter list-unstyled p-0 mt-10 mb-0">
									<li>
