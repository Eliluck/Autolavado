					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">My Account</h1>
							...
							<div class="tab-content" id="loginTabContent">
								<div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
									<form action="#">
										...
										<div class="form-check mb-5 p-0">
											...
											<a href="javascript:void(0);" class="float-right text-body txtLink">Lost your password?</a>
										</div>
										<button type="submit" class="btn btnThemeAlt fwMedium w-100 d-block text-capitalize position-relative border-0 p-0" data-hover="Login">
								...
								<div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
									<form action="#">
										...
										<button type="submit" class="btn btnThemeAlt fwMedium w-100 d-block text-capitalize position-relative border-0 mt-5 p-0" data-hover="Register">
