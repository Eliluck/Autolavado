	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Cart</h1>
			...
			<article class="ItemfullBlock pt-7 pb-7 pt-md-10 pb-md-9 pt-lg-14 pb-lg-13 pt-xl-22 pb-xl-19">
				<div class="container">
					<div class="cartTableWrap table-responsive mb-8 mb-md-12 mb-xl-16">
						<!-- cartTable -->
						<table class="table cartTable mb-0 fontAlter">
							<thead>
								<tr>
									<th class="col01">Product</th>
									<th class="col02">Price</th>
									<th class="col03">Quality</th>
									<th class="col04">Total</th>
								</tr>
							</thead>
							<tbody>
								<tr class="product-cart-item">
									<td class="cart-item-details">
										<div class="product-meta-data d-flex align-items-center">
											<img src="https://via.placeholder.com/50x50" class="img-fluid mr-3" alt="image description">
											<h6 class="h6 mb-0 fwmMedium">Spark Plug Kit-400</h6>
										</div>
									</td>
									<td class="product-subtotal">
										<div class="product-price-amount">
											<h6 class="h6 fwmMedium mb-0"> £95.00</h6>
										</div>
									</td>
									...
									<td class="product-total">
										<div class="product-price-amount">
											<h6 class="h6 fwmMedium mb-0"> £190.00</h6>
											<a href="javascript:void(0);" class="remove-item fas fa-times"></a>
										</div>
									</td>
								</tr>
								<tr class="product-cart-item">
									<td class="cart-item-details">
										<div class="product-meta-data d-flex align-items-center">
											<img src="https://via.placeholder.com/50x50" class="img-fluid mr-3" alt="image description">
											<h6 class="h6 mb-0 fwmMedium">Briliant Pro Chemicals</h6>
										</div>
									</td>
									<td class="product-subtotal">
										<div class="product-price-amount">
											<h6 class="h6 fwmMedium mb-0"> £34.00</h6>
										</div>
									</td>
									<td class="product-quantity">
										<div class="quantity position-relative">
								...
								<tr class="product-cart-item">
									<td class="cart-item-details">
										<div class="product-meta-data d-flex align-items-center">
											<img src="https://via.placeholder.com/50x50" class="img-fluid mr-3" alt="image description">
											<h6 class="h6 mb-0 fwmMedium">Twin Exhaster Pipe</h6>
										</div>
									</td>
									<td class="product-subtotal">
										<div class="product-price-amount">
											<h6 class="h6 fwmMedium mb-0"> £87.00</h6>
										</div>
									</td>
									<td class="product-quantity">
										<div class="quantity position-relative">
							...
							<tfoot>
								<tr>
									<td colspan="4">
										<!-- coupenEnterWrap -->
										<div class="coupenEnterWrap d-flex justify-content-between align-items-center">
											<div class="wrap1 d-flex align-items-center">
												<!-- coupenFormControl -->
												<input type="text" class="form-control coupenFormControl" placeholder="Coupon Code">
												<a href="javascript:void(0);" class="btn btnThemeAlt fwMedium ml-3 ml-xl-6 text-capitalize position-relative border-0 p-0 flex-shrink-0" data-hover="Apply Coupon">
													<span class="d-block btnText">Apply Coupon</span>
												</a>
											</div>
											<button type="submit" class="btn btnTheme fwMedium btnMinSm text-capitalize position-relative border-0 p-0" data-hover="Update Cart">
												<span class="d-block btnText">Update Cart</span>
											</button>
										</div>
									</td>
								</tr>
					...
					<div class="row">
						<div class="col-12 offset-md-4 col-md-8 offset-lgwd-6 col-lgwd-6">
							<h3 class="h4 mb-5 mb-md-8">Cart Totals</h3>
							<div class="crttTableWrap table-responsive mb-5">
							<!-- cartTotals -->
								<table class="table cartTotals border-0 mb-0 fontAlter">
									<tbody>
										<tr>
											<td class="col01">Subtotal</td>
											<td class="col02"><strong class="fwmMedium price d-block">£34.00</strong></td>
										</tr>
										<tr>
											<td class="col01">Shipping</td>
											<td class="col02">
												<!-- tdWrap -->
												<div class="tdWrap">
													<div class="fakeLabelWrap mb-2">
													...
													<strong class="d-block text-secondary mb-3 fwmMedium">Calculate Shipping</strong>
													<div class="coolSelectWrapper mb-2">
														<!-- coolSelect -->
														<select class="coolSelect form-control" id="select-country">
													...
													<div class="coolSelectWrapper mb-2">
														<!-- coolSelect -->
														<select class="coolSelect form-control" id="select-city">
													...
													<div class="formCol">
														...
														<label class="form-group d-block">
															<input type="text" class="form-control d-block w-100" placeholder="Postcode/ZIP">
														</label>
													</div>
													<a href="javascript:void(0);" class="btn btnGary text-capitalize position-relative border-0 p-0" data-hover="Update Totals">
														<span class="d-block btnText">Update Totals</span>
													</a>
												</div>
											</td>
										</tr>
										<tr class="trTotal">
											<td class="col01">Total</td>
											<td class="col02"><strong class="fwmMedium price d-block">£198.00</strong></td>
										</tr>
									</tbody>
								</table>
							</div>
							<button type="submit" class="btn btnThemeAlt fwMedium w-100 d-block text-capitalize position-relative border-0 p-0" data-hover="Proceed to Checkout">
								<span class="d-block btnText">Proceed to Checkout</span>
							</button>
						</div>
					</div>
				</div>
