...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">About Us</h1>
			...
			<!-- aboutBlock -->
			<article class="aboutBlock pt-13 pb-7 pt-sm-15 pb-md-10 pt-lg-18 pb-lg-18 pt-xl-22 pb-xl-23">
				<div class="container">
					<div class="row mb-10 mb-lg-14 mb-xl-22 mx-xl-n5">
							...
							<div class="align pr-lg-10 pr-xl-15">
								<header class="headingHead mb-5">
									<h2 class="fwSemi">
										...
										<span class="d-block">Professional Washing and Cleaning of Your Car</span>
									</h2>
								</header>
					...
					<div class="row">
						<div class="col-12 col-lg-6">
							<!-- abtBlockColumn -->
							<article class="abtBlockColumn position-relative mb-10 mb-lg-0">
								<span class="icnWrap d-flex align-item-center mb-4">
									<i class="icomoon-like"></i>
								</span>
								<h4 class="h4 mb-6">Our Mission, Vision, Values.</h4>
								<div class="row">
									<div class="col-12 col-sm-5 col-lg-12 col-xl-5">
										<div class="imgWrap mb-4 mb-sm-0 mb-lg-4 mb-xl-0">
											<img src="https://via.placeholder.com/240x300" class="img-fluid" alt="image description">
										</div>
									</div>
						...
						<div class="col-12 col-lg-6">
							<!-- abtBlockColumn -->
							<article class="abtBlockColumn position-relative">
								<span class="icnWrap d-flex align-item-center mb-4">
									<i class="icomoon-medal"></i>
								</span>
								<h4 class="h4 mb-6">Inspiring People to Shine</h4>
								<div class="row">
									<div class="col-12 col-sm-5 col-lg-12 col-xl-5">
										<div class="imgWrap mb-4 mb-sm-0 mb-lg-4 mb-xl-0">
											<img src="https://via.placeholder.com/240x300" class="img-fluid" alt="image description">
			...
			<!-- meetTheTeamSection -->
			<section class="meetTheTeamSection pt-10 pt-md-12 pt-lg-18 pt-lgwd-22 pb-sm-3 pb-lg-6 pb-lgwd-12">
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-10 offset-md-1 col-xl-6 offset-xl-3">
							<header class="headingHead fzMedium mb-12 text-center">
								<h2 class="fwSemi">
									<strong class="d-block text-uppercase hTitle fwMedium mb-4">Power Behind Us</strong>
									<span class="d-block">Meet the Team Members</span>
								</h2>
								<p>We know the most integral part of our success is our team members. Our goals of delivering exceptional customer service are high.</p>
							</header>
						</div>
					</div>
					<div class="row">
						<div class="col-12 col-sm-6 col-lg-3">
							<!-- mccColumn -->
							<article class="mccColumn mb-6 position-relative text-center mx-auto mx-sm-0">
								<div class="imgHolder position-relative">
									<img src="https://via.placeholder.com/295x295" class="img-fluid d-block w-100" alt="image description">
									<div class="mcssHolder">
										<ul class="mcssList list-unstyled rounded bg-white overflow-hidden p-0 m-0 d-flex">
											<li>
												<a href="javascript:void(0);" class="mcssLink" title="Twitter"><i class="vssIcn fab fa-twitter"></i></a>
											</li>
											<li>
												<a href="javascript:void(0);" class="mcssLink" title="Facebook"><i class="vssIcn fab fa-facebook-square"></i></a>
											</li>
											<li>
												<a href="javascript:void(0);" class="mcssLink" title="Linkedin"><i class="vssIcn fab fa-linkedin-in"></i></a>
											</li>
										</ul>
									</div>
								</div>
								<div class="mcCaptionWrap pt-5 pb-4 position-relative">
									<h6 class="mccName mb-2">Cevin Peter</h6>
									<h6 class="mccDesig text-secondary mb-0 text-uppercase fwmMedium">Owner/Operator</h6>
								</div>
							</article>
						</div>
						<div class="col-12 col-sm-6 col-lg-3">
							...
							<article class="mccColumn mb-6 position-relative text-center mx-auto mx-sm-0">
								...
								<div class="mcCaptionWrap pt-5 pb-4 position-relative">
									<h6 class="mccName mb-2">Carleno Emo</h6>
									<h6 class="mccDesig text-secondary mb-0 text-uppercase fwmMedium">General Manager</h6>
								</div>
							</article>
						</div>
						<div class="col-12 col-sm-6 col-lg-3">
							...
							<article class="mccColumn mb-6 position-relative text-center mx-auto mx-sm-0">
								...
								<div class="mcCaptionWrap pt-5 pb-4 position-relative">
									<h6 class="mccName mb-2">Robert Peterson</h6>
									<h6 class="mccDesig text-secondary mb-0 text-uppercase fwmMedium">Wash Technician</h6>
								</div>
							</article>
						</div>
						<div class="col-12 col-sm-6 col-lg-3">
							...
							<article class="mccColumn mb-6 position-relative text-center mx-auto mx-sm-0">
								...
								<div class="mcCaptionWrap pt-5 pb-4 position-relative">
									<h6 class="mccName mb-2">Donald Trump</h6>
									<h6 class="mccDesig text-secondary mb-0 text-uppercase fwmMedium">Service Engineer</h6>
								</div>
							</article>
						</div>
					</div>
			...
			<!-- testimonialsBlock -->
			<article class="testimonialsBlock overlay position-relative pt-10 pb-5 pb-md-7 pt-lg-14 pb-lg-12 pt-lgwd-18 pb-lgwd-15 pt-xl-21 pb-xl-19">
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-10 offset-md-1 col-xl-6 offset-xl-3">
