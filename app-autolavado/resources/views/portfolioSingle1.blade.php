...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
					...
					<div class="alignHolder w-100 d-flex align-items-center">
						<div class="align w-100 py-8 py-md-14 py-lg-20">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h1 class="text-white font-weight-bold mb-4 h2Large">Interior Dusting</h1>
			...
			<!-- ItemfullBlock -->
			<article class="ItemfullBlock portfolioSingle bodyFontAlter py-8 py-md-10 py-lg-14 py-xl-22">
				<div class="container">
					<div class="row mb-3 mb-md-6">
						<div class="col-12 col-sm-6">
							<!-- gPhoColumn -->
							<article class="gPhoColumnGallery position-relative overflow-hidden mb-6">
								<div class="imgWrap position-relative">
									<img src="https://via.placeholder.com/620x460" class="img-fluid w-100" alt="image description">
									<a href="https://via.placeholder.com/620x460" class="icnSearch lightbox position-absolute" data-fancybox="true"><i class="lnr lnr-magnifier"><span class="sr-only">icon</span></i></a>
								</div>
							</article>
						</div>
						<div class="col-12 col-sm-6">
					...
					<div class="row">
						<div class="col-12 col-md-7 col-lg-8 col-xl-9">
							<div class="pr-lg-10 pr-xlwd-13">
								<header class="fzLarge mb-6">
									<p class="text-lDark mb-6">We help our clients to build their best possible economic We understand you’re saving for all different life events: retirement, a house, simply to build wealth, or all of the above. Your famous investment account should adjust to your life — not the other way around.</p>
								</header>
								<p class="mb-6">You have within you, right now, at this very moment, all that is necessary for you to become the happy, successful person you’ve always wanted to be. All you need to do is unlock the riches that have been locked away with-in you. Being lucky in life is the result of putting yourself into action for good luck to happen to you. You’ve probably heard the statement “The harder I work the luckier I get”. Another way.</p>
								<p>We decided to create a thought leadership campaign around four future-focused films and a new website around the themes of Technology, Placemaking &amp; Society, Climate &amp; Resources and Mobility – issues that pose challenges and opportunities for our people and places.</p>
							</div>
						</div>
						<div class="col-12 col-md-5 col-lg-4 col-xl-3">
							<!-- widget / psShareWidget -->
							<div class="widget psShareWidget shadow bg-white mt-5 mt-md-0 px-4 px-lg-6 pt-7 pb-8">
								<ul class="psMetaList fontAlter list-unstyled p-0 m-0">
									<li>
										<strong class="d-block fwmMedium text-lDark mb-1 fontAlter">Category:</strong>
										<span class="d-block">Washing</span>
									</li>
									<li>
										<strong class="d-block fwmMedium text-lDark mb-1 fontAlter">Date:</strong>
										<span class="d-block">12 March 2020</span>
									</li>
									<li>
										<strong class="d-block fwmMedium text-lDark mb-1 fontAlter">Location:</strong>
										<span class="d-block">Melborne, AUS</span>
									</li>
									<li>
										<strong class="d-block fwmMedium text-lDark mb-1 fontAlter">Service:</strong>
										<span class="d-block">Full service car wash</span>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<!-- saShareAside -->
					<aside class="saShareAside d-flex align-items-center justify-content-between mt-7 mt-md-13">
						...
						<ul class="list-unstyled mb-0 pnnPaginList d-flex fontAlter justify-content-between">
							<li>
								...
								<strong class="h4 d-none d-sm-block fwSemiBold mb-0">
									<a href="javascript:void(0);">Wax With Carnauba</a>
								</strong>
							</li>
							<li>
								<a href="javascript:void(0);">Next</a>
								<strong class="h4 d-none d-sm-block fwSemiBold mb-0">
									<a href="javascript:void(0);">RMW Mini Cooper</a>
								</strong>
							</li>
						</ul>
			...
			<section class="bgLight pt-8 pt-md-12 pt-xl-16 pb-2 pb-md-3 pb-lg-7 pb-xl-10 pb-xl-16">
				<div class="container">
					<h4 class="text-center fwSemiBold mb-5 mb-md-8">Related Projects</h4>
					<div class="row">
						<div class="col-12 col-md-6 col-lg-4">
							<!-- gPhoColumn -->
							<article class="gPhoColumn position-relative overflow-hidden mb-8 mb-lg-6">
								...
								<a href="portfolioSingle1.html" class="d-inline-block pgLink pgLinkAlt"><i class="rounded-circle icomoon-arrowRight d-flex align-items-center justify-content-center pgLinkGo"><span class="sr-only">icon</span></i></a>
							</article>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<!-- gPhoColumn -->
